...
**Version**: 1.0.0 (MVP)
**Status**: ⚠️ **Active Development** - Critical P0 fixes in progress

---

## UNITE-HUB – Current Application Overview
...
│   ├── agent.md                  # Agent definitions (THIS IS CANONICAL)
...
│   │   ├── HotLeadsPanel.tsx     # Hot leads widget
│   │   └── [100+ components]
│   │
│   ├── lib/                      # Utilities
│   │   ├── agents/               # Agent logic
...
### ⚠️ Critical Issues (P0 - SYSTEM BREAKING)
...
✅ **Core Flows**:
- Email processing pipeline (Gmail → Contact Intelligence → Scoring)
- Content generation pipeline (Warm Leads → Personalized Content → Drafts)

...
-- Scores policies
drop policy if exists "scores_select_own" on synthex_audience_scores;
...
drop policy if exists "scores_insert_own" on synthex_audience_scores;
...
drop policy if exists "scores_update_own" on synthex_audience_scores;
...
drop policy if exists "scores_delete_own" on synthex_audience_scores;
...
-- Events policies
drop policy if exists "events_select_own" on synthex_audience_events;
...
drop policy if exists "events_insert_own" on synthex_audience_events;
...
drop trigger if exists set_updated_at_audience_scores on synthex_audience_scores;

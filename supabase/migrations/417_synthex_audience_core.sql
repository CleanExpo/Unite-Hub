...
-- RLS Policies
drop policy if exists "audiences_select" on synthex_audiences;
...
drop policy if exists "audiences_insert" on synthex_audiences;
...
drop policy if exists "audiences_update" on synthex_audiences;
...
drop policy if exists "audiences_delete" on synthex_audiences;
...
-- RLS Policies
drop policy if exists "audience_contacts_select" on synthex_audience_contacts;
...
drop policy if exists "audience_contacts_insert" on synthex_audience_contacts;
...
drop policy if exists "audience_contacts_update" on synthex_audience_contacts;
...
drop policy if exists "audience_contacts_delete" on synthex_audience_contacts;
...
-- RLS Policies
drop policy if exists "segments_select" on synthex_segments;
...
drop policy if exists "segments_insert" on synthex_segments;
...
drop policy if exists "segments_update" on synthex_segments;
...
drop policy if exists "segments_delete" on synthex_segments;
...
-- Performance indexes
drop index if exists idx_synthex_segment_contacts_segment;
create index if not exists idx_synthex_segment_contacts_segment on synthex_segment_contacts(segment_id);
drop index if exists idx_synthex_segment_contacts_contact;
...
-- RLS Policies
drop policy if exists "segment_contacts_select" on synthex_segment_contacts;
...
drop policy if exists "segment_contacts_insert" on synthex_segment_contacts;
...
drop policy if exists "segment_contacts_delete" on synthex_segment_contacts;

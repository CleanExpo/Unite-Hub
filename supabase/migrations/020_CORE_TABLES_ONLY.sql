-- =====================================================
-- MIGRATION 020 CLEAN: Implement REAL Row Level Security Policies
-- =====================================================
-- Date: 2025-01-17
-- Purpose: Restore RLS after migration 019 V3
-- CLEAN APPROACH: Drop everything first, then recreate with TEXT casting

-- =====================================================
-- STEP 1: DROP ALL EXISTING FUNCTIONS (from failed migrations)
-- =====================================================
...
-- =====================================================
-- STEP 2: DROP ALL EXISTING POLICIES (from failed migrations)
-- =====================================================
...
-- Generated content
DROP POLICY IF EXISTS "generatedContent_org_select" ON "generatedContent" CASCADE;
DROP POLICY IF EXISTS "generatedContent_org_insert" ON "generatedContent" CASCADE;
DROP POLICY IF EXISTS "generatedContent_org_update" ON "generatedContent" CASCADE;
DROP POLICY IF EXISTS "generatedContent_org_delete" ON "generatedContent" CASCADE;

-- Audit logs
DROP POLICY IF EXISTS "auditLogs_org_select" ON "auditLogs" CASCADE;
DROP POLICY IF EXISTS "auditLogs_org_insert" ON "auditLogs" CASCADE;
...
-- =====================================================
-- STEP 4: CREATE HELPER FUNCTIONS (TEXT-based)
-- =====================================================
...
-- =====================================================
-- STEP 5: CREATE POLICIES (all tables)
-- =====================================================
...
COMMENT ON FUNCTION get_user_workspaces() IS 'Returns TEXT workspace IDs with TEXT casting';
COMMENT ON FUNCTION user_has_role_in_org_simple(TEXT, TEXT) IS 'Role hierarchy check with TEXT casting';

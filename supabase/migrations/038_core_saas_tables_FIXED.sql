-- =====================================================
-- CORE SAAS TABLES - Phase 1 Emergency Stabilization (FIXED)
-- =====================================================
-- Purpose: Create missing core tables that are referenced in 10+ files
-- Date: 2025-01-18
-- Version: 1.1 (Fixed table ordering)
-- Mode: ADDITIVE - Idempotent migration
-- Priority: P0 - SYSTEM BREAKING
-- =====================================================
-- FIX: Reordered tables to respect foreign key dependencies
-- =====================================================
...
-- =====================================================
-- TABLE 3: email_integrations (MOVED BEFORE client_emails)
-- =====================================================
...
-- =====================================================
-- TABLE 6: client_emails (NOW AFTER email_integrations)
-- =====================================================

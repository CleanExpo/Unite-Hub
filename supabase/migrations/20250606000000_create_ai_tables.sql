...
-- Indexes
CREATE INDEX idx_ai_threat_detections_type ON ai_threat_detections(threat_type);
CREATE INDEX idx_ai_threat_detections_severity ON ai_threat_detections(severity);
CREATE INDEX idx_ai_threat_detections_status ON ai_threat_detections(mitigation_status);
CREATE INDEX idx_ai_threat_detections_detected ON ai_threat_detections(detected_at DESC);

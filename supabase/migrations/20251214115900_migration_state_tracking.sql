-- =====================================================
-- Migration: Migration State Tracking (timestamped)
...
COMMENT ON COLUMN _migrations.filename IS 'Migration filename (e.g., 20251214115900_migration_state_tracking.sql)';
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE '=== Migration State Tracking Applied ===';
  ...
  IF tables_created = 2 AND indexes_created = 5 THEN
    RAISE NOTICE 'SUCCESS: State tracking infrastructure ready';
  ELSE
    RAISE WARNING 'INCOMPLETE - Review output above';
  END IF;
  RAISE NOTICE '========================================';
END $$;

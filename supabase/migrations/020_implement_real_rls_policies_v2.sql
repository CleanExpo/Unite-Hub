-- =====================================================
-- MIGRATION 020 V2: Implement REAL Row Level Security Policies
-- =====================================================
-- Date: 2025-01-17
...
-- Handles TEXT workspace IDs (not converted to UUID yet)
...
-- =====================================================
-- Returns TEXT workspace IDs (workspaces.id is TEXT, not UUID)
...
CREATE OR REPLACE FUNCTION user_has_role_in_org(
  p_org_id UUID,  -- organizations.org_id is now UUID after migration 019
...
DROP POLICY IF EXISTS "Service role can manage memberships" ON user_organizations;
...
DECLARE
  ...
  total_tables INT := 12; -- Expected number of tables with RLS
BEGIN
...
-- COMMENTS
-- =====================================================
COMMENT ON FUNCTION get_user_workspaces() IS 'Returns TEXT workspace IDs user has access to';

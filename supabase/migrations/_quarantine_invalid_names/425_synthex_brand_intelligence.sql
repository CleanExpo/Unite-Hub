...
-- ============================================
drop index if exists idx_brand_voices_tenant;
...
drop policy if exists "synthex_brand_voices_select" on synthex_brand_voices;
...
drop policy if exists "synthex_brand_voices_insert" on synthex_brand_voices;
...
-- Updated At Triggers
-- ============================================
drop trigger if exists trigger_brand_voices_updated_at on synthex_brand_voices;
...
drop trigger if exists trigger_brand_templates_updated_at on synthex_brand_templates;

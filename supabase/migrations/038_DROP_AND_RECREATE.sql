-- =====================================================
-- Migration 038: Drop and Recreate Tables
-- =====================================================
-- WARNING: This will DROP existing projects table and data!
-- Only run if you're okay losing existing projects data
-- =====================================================
...
-- Create projects table (FRESH, not IF NOT EXISTS)
...
CREATE INDEX idx_email_integrations_workspace_id ON email_integrations(workspace_id);
...
CREATE INDEX idx_client_emails_contact_id ON client_emails(contact_id);
GRANT SELECT, INSERT, UPDATE ON client_emails TO authenticated;

-- Verification
SELECT 'SUCCESS: 4 tables created (projects, email_integrations, sent_emails, client_emails)' AS result;

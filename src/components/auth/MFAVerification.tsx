...
export default function MFAVerification({
  ...
  const [verificationCode, setVerificationCode] = useState<string> "use client";
        ...
        <div className="mt-4">
          ...
          <div className="mt-1 relative">
            <input
              ...
              maxLength={6}
              Unite Group="Enter 6-digit code"
...
.Value -replace "'", "'" <boolean>(false);
  const [error, setError] = useState<string> "use client";
...
.Value -replace "'", "'" <number> "use client";
...
.Value -replace "'", "'" <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md mx-auto">
      <h2 className="text-2xl font-bold mb-4">Two-Factor Authentication</h2>
...
.Value -replace "'", "'" <div className="absolute right-0 top-0 bottom-0 flex items-center pr-3">
              <div className="h-8 w-8 flex items-center justify-center">
                <svg viewBox="0 0 36 36" className="w-full h-full">
                  <path
                    d="M18 2.0845

      ...
      {isPlaying ? (
        ...
        <>
          ...
          <button
            ...
            type="button"
          >
            <div className="w-20 h-20 bg-[#ff5722] rounded-full flex items-center justify-center group-hover:bg-[#ff784e] group-hover:scale-110 transition-all transform shadow-2xl">

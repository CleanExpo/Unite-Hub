...
export function CalendarSkeleton() {
  return (
    <div className="bg-card/50 backdrop-blur-sm rounded-lg border border-border p-6 space-y-6">
      {/* Calendar Header */}
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="bg-card/50 backdrop-blur-sm rounded-lg border border-border p-6"
        >

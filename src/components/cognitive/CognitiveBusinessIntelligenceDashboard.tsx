...
export default function CognitiveBusinessIntelligenceDashboard() {
  ...
  const [lastUpdate, setLastUpdate] = useState<Date | null> 'use client';
...
.Value -replace "'", "'" <TrendingUp className="h-4 w-4 text-green-600" /> 'use client';
...
.Value -replace "'", "'" <AlertCircle className="h-4 w-4 text-red-600" /> 'use client';
...
.Value -replace "'", "'" <Zap className="h-4 w-4 text-blue-600" /> 'use client';
...
.Value -replace "'", "'" <BarChart3 className="h-4 w-4 text-purple-600" /> 'use client';
...
.Value -replace "'", "'" <Activity className="h-4 w-4 text-orange-600" />;
      default: return <Lightbulb className="h-4 w-4 text-gray-600" /> 'use client';
              ...
              <Card key={insight.id} className="relative">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="font-medium">Impact: </span>
                      <span className={insight.impact > 'use client';

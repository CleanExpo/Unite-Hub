...
interface StripePaymentFormProps {
  ...
  description?: string;
  customerId?: string;
  metadata?: Record<string, string> "use client";
...
.Value -replace "'", "'" <string | null>(null);
  const [stripe, setStripe] = useState<any | null>(null);
  const [elements, setElements] = useState<StripeElements | null>(null);
  const [clientSecret, setClientSecret] = useState<string | null> "use client";
...
.Value -replace "'", "'" <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        <CardTitle className="text-xl">Payment Details</CardTitle>
        <CardDescription>
          {isSuccess 

...
const features = [
  {
    icon: <MessageSquare className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Brain className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Cloud className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Shield className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Zap className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <BarChart3 className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Users className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Lock className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <Globe className="h-8 w-8" /> 'use client'
...
.Value -replace "'", "'" <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 justify-center"> 'use client'
...
.Value -replace "'", "'" <Badge key={item} variant="secondary" className="bg-white/20 text-white border-white/30">
                {item}
              </Badge>
            ))}
          </div>

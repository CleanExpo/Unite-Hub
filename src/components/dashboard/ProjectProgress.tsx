...
export function ProjectProgress({ projectId, projectTitle, className }: ProjectProgressProps) {
  const [milestones, setMilestones] = useState<ProjectMilestone[]> 'use client';
...
.Value -replace "'", "'" <CheckCircle className="h-4 w-4" /> 'use client';
...
.Value -replace "'", "'" <Clock className="h-4 w-4" /> 'use client';
...
.Value -replace "'", "'" <AlertCircle className="h-4 w-4" />;
      default:
        return <Target className="h-4 w-4" /> 'use client';
...
.Value -replace "'", "'" <Badge className="bg-green-600/20 text-green-400 border-green-800">Completed</Badge> 'use client';
...
.Value -replace "'", "'" <Badge className="bg-blue-600/20 text-blue-400 border-blue-800">In Progress</Badge> 'use client';
...
.Value -replace "'", "'" <Badge className="bg-red-600/20 text-red-400 border-red-800">Delayed</Badge>;
      default:
        return <Badge className="bg-slate-600/20 text-slate-400 border-slate-800">Pending</Badge> 'use client';
...
.Value -replace "'", "'" <Card className={cn("bg-slate-800 border-slate-700", className)}>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Target className="h-5 w-5 text-teal-400" />

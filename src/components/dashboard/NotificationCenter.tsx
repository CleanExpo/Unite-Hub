...
export function NotificationCenter({ userId, className }: NotificationCenterProps) {
  const [notifications, setNotifications] = useState<Notification[]> 'use client';
...
.Value -replace "'", "'" <Info className="h-4 w-4" /> 'use client';
...
.Value -replace "'", "'" <AlertCircle className="h-4 w-4" />;
      default:
        return <Bell className="h-4 w-4" /> 'use client';

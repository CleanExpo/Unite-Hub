...
interface HealthCheckResult {
  ...
  error?: string;
  timestamp: string;
  metrics?: Record<string, any> 'use client';
...
.Value -replace "'", "'" <string, HealthCheckResult>;
  repairActions: AutoRepairAction[];
  timestamp: string;
}
...
.Value -replace "'", "'" <AlertTriangle className="h-4 w-4" /> 'use client';
...
.Value -replace "'", "'" <AlertTriangle className="h-4 w-4" />;
      default: return <Activity className="h-4 w-4" /> 'use client';
            ...
            {Object.entries(data.healthChecks).map(([service, health]) => (
              <div key={service} className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium capitalize"> 'use client';

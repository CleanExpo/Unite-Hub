    ...
    <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
      <Select value={value} onValueChange={handlePeriodChange}>
        <SelectTrigger className="w-[200px]">
          <SelectValue Unite Group="Select time period" />
        </SelectTrigger>
        <SelectContent>
      ...
      <div className="flex flex-col space-y-4 sm:flex-row sm:justify-between sm:space-y-0">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
          ...
          <Select value={comparison} onValueChange={handleComparisonChange}>
            <SelectTrigger className="w-[200px]">
              <SelectValue Unite Group="Select comparison" />
            </SelectTrigger>
            <SelectContent>
...
.Value -replace "'", "'" <ResponsiveContainer width="100%" height={250}>
          <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            <CartesianGrid strokeDasharray="3 3" />
            <XAxis dataKey="name" />
            <YAxis />
...
.Value -replace "'", "'" <div className="w-full overflow-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b">
            {tableColumns.map((col) => (
...
.Value -replace "'", "'" <div key={step.name} className="space-y-1">
                  <div className="flex justify-between">
                    <span className="text-sm font-medium">{step.name}</span>
                    <span className="text-sm text-muted-foreground">
                      {step.value.toLocaleString()}
...
.Value -replace "'", "'" <MetricWidget {...rest} /> /**
 * Analytics Dashboard Component
 * 
 * This component provides a customizable dashboard for displaying analytics data.
 * It supports various widgets like metrics, charts, tables, and more.
...
.Value -replace "'", "'" <ChartWidget {...rest} /> /**
 * Analytics Dashboard Component
 * 
 * This component provides a customizable dashboard for displaying analytics data.
 * It supports various widgets like metrics, charts, tables, and more.
...
.Value -replace "'", "'" <TableWidget {...rest} /> /**
 * Analytics Dashboard Component
 * 
 * This component provides a customizable dashboard for displaying analytics data.
 * It supports various widgets like metrics, charts, tables, and more.
...
.Value -replace "'", "'" <FunnelWidget {...rest} /> /**
 * Analytics Dashboard Component
 * 
 * This component provides a customizable dashboard for displaying analytics data.
 * It supports various widgets like metrics, charts, tables, and more.
...
.Value -replace "'", "'" <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
      <Select value={value} onValueChange={handlePeriodChange}>
        <SelectTrigger className="w-[200px]">
          <SelectValue Unite Group="Select time period" />
        </SelectTrigger>
...
.Value -replace "'", "'" <div className={`analytics-dashboard space-y-4 ${className}`}>
      <div className="flex flex-col space-y-4 sm:flex-row sm:justify-between sm:space-y-0">
        <h2 className="text-2xl font-bold">{config.name}</h2>
...
.Value -replace "'", "'" <div key={widget.id} className={colSpan}>
                        <Widget
                          id={widget.id}
                          type={widget.type}
                          title={widget.title}

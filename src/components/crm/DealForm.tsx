      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              <SelectTrigger>
                <SelectValue Unite Group="Select a stage" />
              </SelectTrigger>
              <SelectContent>
                {stages.map(stage => (
          ...
          <div>
            ...
            >
              <SelectTrigger>
                <SelectValue Unite Group="Select an assignee" />
              </SelectTrigger>
              <SelectContent>
                {users.map(user => (
...
.Value -replace "'", "'" <HTMLInputElement | HTMLTextAreaElement> 'use client';
...
.Value -replace "'", "'" </AvatarFallback>
          ...
          <div className="flex justify-end">
            <Button type="submit" disabled={loading}> 'use client';

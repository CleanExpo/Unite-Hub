...
export function InvoiceListPage({ onInvoiceSelect }: InvoiceListPageProps) {
  const [invoices, setInvoices] = useState<Invoice[]> 'use client'
...
export default InvoiceListPage
.Value -replace "'", "'" <Clock className="h-4 w-4" />
      default: return <FileText className="h-4 w-4" /> 'use client'
...
export default InvoiceListPage
.Value -replace "'", "'" < new Date()
  }

  const getTotalRevenue = () => 'use client'

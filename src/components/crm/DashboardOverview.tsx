...
export const DashboardOverview: React.FC<DashboardOverviewProps> import React from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import { Activity, Mail, FileText, PlusCircle, Calendar, Users } from 'lucide-react';
...
.Value -replace "'", "'" <div className="flex flex-col gap-6">
      {/* Quick Actions */}
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <Button className="flex flex-col h-24 justify-center items-center gap-2 bg-slate-800 hover:bg-slate-700 border border-slate-700">
          <PlusCircle className="h-6 w-6 text-teal-400" />
      ...
      <Card className="bg-slate-800 border-slate-700">
        ...
        <CardContent>
          <div className="space-y-4">
            {activitiesToShow.map((activity) => (
              <div key={activity.id} className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-1"> import React from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import { Activity, Mail, FileText, PlusCircle, Calendar, Users } from 'lucide-react';
...
.Value -replace "'", "'" <Mail className="h-5 w-5 text-teal-400" /> import React from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import { Activity, Mail, FileText, PlusCircle, Calendar, Users } from 'lucide-react';
...
.Value -replace "'", "'" <FileText className="h-5 w-5 text-teal-400" /> import React from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import { Activity, Mail, FileText, PlusCircle, Calendar, Users } from 'lucide-react';
...
.Value -replace "'", "'" <Activity className="h-5 w-5 text-teal-400" />}
                </div>
                <div>
                  <div className="font-medium text-white">{activity.title}</div>
                  <div className="text-sm text-slate-400">

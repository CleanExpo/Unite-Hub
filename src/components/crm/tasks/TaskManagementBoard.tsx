...
export function TaskManagementBoard({ onTaskSelect }: TaskManagementBoardProps) {
  ...
  const [filteredTasks, setFilteredTasks] = useState<Task[]> 'use client'
...
export default TaskManagementBoard
.Value -replace "'", "'" <AlertCircle className="h-4 w-4" /> 'use client'
...
export default TaskManagementBoard
.Value -replace "'", "'" <CheckCircle2 className="h-4 w-4" /> 'use client'
...
export default TaskManagementBoard
.Value -replace "'", "'" < 0) return `${Math.abs(diffDays)} days overdue`
    return `${diffDays} days left`
  }
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">In Progress</p>
                <p className="text-2xl font-bold text-blue-600"> 'use client'
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Overdue</p>
                <p className="text-2xl font-bold text-red-600"> 'use client'

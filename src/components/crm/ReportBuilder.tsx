...
export default function ReportBuilder() {
  ...
  const [componentType, setComponentType] = useState<'table' | 'chart' | 'kpi'> import React, { useState, useEffect } from 'react';
import { useReportBuilder } from '@/context/ReportBuilderContext';
import { Button } from '@/components/ui/button';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
import { Input } from '@/components/ui/input';
...
.Value -replace "'", "'" <div className="p-6">
      <Card className="mb-6">
        <CardHeader>
          <CardTitle>Custom Report Builder</CardTitle>
        </CardHeader>
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-2">
                  ...
                  <Select value={componentType} onValueChange={(value) => import React, { useState, useEffect } from 'react';
import { useReportBuilder } from '@/context/ReportBuilderContext';
import { Button } from '@/components/ui/button';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
import { Input } from '@/components/ui/input';
...
.Value -replace "'", "'" <SelectTrigger className="w-[100px]">
                      <SelectValue Unite Group="Type" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="table">Table</SelectItem>
                ...
                >
                  {currentReport.components.map(comp => (
                    <div key={comp.id} className="bg-white border rounded-lg p-4">
                      ...
                      <div className="text-center text-gray-500"> import React, { useState, useEffect } from 'react';
import { useReportBuilder } from '@/context/ReportBuilderContext';
import { Button } from '@/components/ui/button';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
import { Input } from '@/components/ui/input';

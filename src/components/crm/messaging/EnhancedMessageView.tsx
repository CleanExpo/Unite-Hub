...
export function EnhancedMessageView({
  ...
  const [editingMessage, setEditingMessage] = useState<string | null> 'use client'
...
.Value -replace "'", "'" <strong>$1</strong> 'use client'
...
.Value -replace "'", "'" <em>$1</em> 'use client'
...
.Value -replace "'", "'" <code>$1</code> 'use client'
...
.Value -replace "'", "'" <span class="text-blue-600 font-medium">@${username}</span>`
        }
        return match
      })
    
    return <div dangerouslySetInnerHTML={{ __html: formatted_text }} /> 'use client'
          ...
          <div className="flex-1 space-y-1">
            ...
            {editingMessage === message.id ? (
              ...
              <div className={cn(
                ...
                {/* Read Status */}
                {isCurrentUser && readStatus && (
                  <div className="flex justify-end mt-1"> 'use client'
...
.Value -replace "'", "'" <CheckCheck className="h-3 w-3 text-blue-300" />
                    ) : (
                      <Check className="h-3 w-3 text-gray-300" />
                    )}
                  </div>
        ...
        {showReactionPicker === message.id && (
          <div className="absolute top-8 right-0 bg-white border rounded-lg shadow-lg p-2 z-10">
            <div className="grid grid-cols-6 gap-1"> 'use client'

...
export function UnifiedCustomerDashboard({ customerId }: UnifiedCustomerDashboardProps) {
  const [customer, setCustomer] = useState<UnifiedCustomer | null> 'use client';
...
.Value -replace "'", "'" </span>
                    <Badge variant={value ? 'default' : 'secondary'}> 'use client';
...
.Value -replace "'", "'" </Badge>
        ...
        <TabsContent value="bundles" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4"> 'use client';
...
.Value -replace "'", "'" <div key={bundle.id} className="border rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="font-semibold text-lg">{bundle.name}</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">

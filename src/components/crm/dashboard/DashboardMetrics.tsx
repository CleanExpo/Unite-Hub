  ...
  return (
    <Card className="hover:shadow-lg transition-shadow">
      ...
      <CardContent>
        ...
        {change !== undefined && (
          <p className={`text-xs flex items-center mt-2 ${change > 'use client';
...
.Value -replace "'", "'" <TrendingUp className="h-3 w-3 mr-1" /> 'use client';
...
.Value -replace "'", "'" <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white p-6 rounded-lg">
        <h2 className="text-2xl font-bold mb-2">Executive Summary</h2>
        <p className="text-teal-100"> 'use client';

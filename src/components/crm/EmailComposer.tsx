...
export default function EmailComposer({ 
  ...
  const [ccEmails, setCcEmails] = useState<string[]> 'use client';
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          {toEmails.map((email, index) => (
            <Input
              ...
              Unite Group="recipient@unite-group.in"
              className="mt-1"
            />
          ))}
          <Button
        ...
        <div>
          ...
          >
            <SelectTrigger>
              <SelectValue Unite Group="Select a deal" />
            </SelectTrigger>
            <SelectContent>
              {deals.map(deal => (
        ...
        <div>
          ...
          <Textarea
            ...
            Unite Group="Type your message here..."
            rows={8}
            className="mt-1"
          />
        </div>
...
.Value -replace "'", "'" </Button>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button 
            ...
            disabled={!subject || !body || toEmails.every(e => !e) || sending}
          >
            <Send className="h-4 w-4 mr-2" /> 'use client';

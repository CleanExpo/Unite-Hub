...
export function MeetingListPage({ onMeetingSelect }: MeetingListPageProps) {
  const [meetings, setMeetings] = useState<Meeting[]> 'use client'
...
export default MeetingListPage
.Value -replace "'", "'" <Calendar className="h-4 w-4" /> 'use client'
...
.Value -replace "'", "'" <AlertCircle className="h-4 w-4" />
      default: return <Calendar className="h-4 w-4" /> 'use client'
...
export default MeetingListPage
.Value -replace "'", "'" <Video className="h-4 w-4" /> 'use client'
...
export default MeetingListPage
.Value -replace "'", "'" <Phone className="h-4 w-4" /> 'use client'
...
export default MeetingListPage
.Value -replace "'", "'" <MapPin className="h-4 w-4" />
      default: return <Calendar className="h-4 w-4" /> 'use client'
                  ...
                  {meetings.map((meeting) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge className={getTypeColor(meeting.meeting_type)}>
                            <div className="flex items-center gap-1"> 'use client'
...
.Value -replace "'", "'" </div>
                        ...
                        <TableCell>
                          <div>
                            <p className="text-sm font-medium">{meeting.organizer.full_name}</p>
                            {meeting.attendees.length > 0 && (
                              <p className="text-xs text-gray-600 dark:text-gray-400"> 'use client'
...
export default MeetingListPage
.Value -replace "'", "'" <Button size="sm" variant="ghost">
                                <Video className="h-4 w-4" />
                              </Button>
                            )}
                            <Button size="sm" variant="ghost">

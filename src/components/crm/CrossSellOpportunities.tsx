...
export function CrossSellOpportunities({ customerId, onOpportunitySelect }: CrossSellOpportunitiesProps) {
  ...
  const [selectedOpportunity, setSelectedOpportunity] = useState<CrossSellOpportunity | null> 'use client';
...
.Value -replace "'", "'" <BookOpen className="h-5 w-5" /> : <Package className="h-5 w-5" /> 'use client';
...
.Value -replace "'", "'" <div className="flex items-center justify-center h-64">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-teal-600"></div>
      </div> 'use client';
      ...
      <Card>
        ...
        <CardContent>
          <Tabs defaultValue="all" className="w-full">
            ...
            <TabsContent value="unite-to-carsi" className="space-y-4"> 'use client';
...
.Value -replace "'", "'" <OpportunityCard
            ...
            <TabsContent value="carsi-to-unite" className="space-y-4"> 'use client';

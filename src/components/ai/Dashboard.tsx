...
.Value -replace "'", "'" <div className="flex items-center justify-center h-96">
        <RefreshCw className="h-8 w-8 animate-spin text-muted-foreground" />
      </div>
    );
  }
...
.Value -replace "'", "'" <div>Loading predictions...</div>;
...
.Value -replace "'", "'" <div>Loading threats...</div>;
...
.Value -replace "'", "'" <div>Loading deployments...</div>;

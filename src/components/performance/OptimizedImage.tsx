...
interface OptimizedImageProps extends Omit<ImageProps, 'onLoad' | 'onError'> 'use client';
...
export function OptimizedImage({
  ...
  alt,
  className,
  fallback = '/images/Unite Group.jpg',
  blur = true,
  aspectRatio,
  onLoad,
  onError,
...
.Value -replace "'", "'" <HTMLDivElement> 'use client';
...
export function ResponsiveImage({
  ...
  alt: string;
  className?: string;
} & Omit<OptimizedImageProps, 'src' | 'width' | 'height'> 'use client';
...
export function BackgroundImage({
  ...
  const [isLoaded, setIsLoaded] = useState(false);
  const [isInView, setIsInView] = useState(false);
  const containerRef = useRef<HTMLDivElement> 'use client';

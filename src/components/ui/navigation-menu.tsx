 ...
 * Supports multi-level navigation with dropdown menus.
 * Built on Radix UI NavigationMenu primitive with Synthex design tokens.
 *
 * @example
 * <NavigationMenu>
 *   <NavigationMenuList>
...
const navigationMenuTriggerStyle = cva([
  ...
  "bg-bg-base text-sm font-medium text-text-primary",
  "transition-colors duration-normal ease-out",
  "hover:bg-bg-hover hover:text-accent-500",
  "focus:bg-bg-hover focus:text-accent-500 focus:outline-none",
  "disabled:pointer-events-none disabled:opacity-50",
  "data-[active]:bg-bg-hover/50 data-[state=open]:bg-bg-hover/50",
])
  ...
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        "w-full overflow-hidden rounded-md border border-border-subtle bg-bg-card shadow-lg",

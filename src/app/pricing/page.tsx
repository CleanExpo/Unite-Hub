...
export default function PricingPage() {
  const [billingCycle, setBillingCycle] = useState<'monthly' | 'annually'> 'use client'
...
.Value -replace "'", "'" <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
...
.Value -replace "'", "'" <Badge className="ml-2" variant="secondary">Save 20%</Badge>
            </button>
          </div>
        </motion.div>
...
.Value -replace "'", "'" <>
                        <span className="text-4xl font-bold"> 'use client'
...
.Value -replace "'", "'" </span>
                        <span className="text-gray-600">/month</span> 'use client'
...
.Value -replace "'", "'" <p className="text-sm text-gray-500 mt-1">
                            ${plan.price.annually} billed annually
                          </p>
                        )}
                      </>

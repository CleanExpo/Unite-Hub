...
export default function BusinessStrategyPage() {
  ...
  const strategies = [
    {
      icon: <Lightbulb className="h-8 w-8" /> import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
...
.Value -replace "'", "'" <Target className="h-8 w-8" /> import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
...
.Value -replace "'", "'" <TrendingUp className="h-8 w-8" /> import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
                  ...
                  <Card className={`h-full ${model.recommended ? 'border-indigo-600 shadow-xl' : ''}`}>
                    <CardHeader>
                      ...
                      <div className="flex items-baseline gap-2 mt-4">
                        <span className="text-4xl font-bold text-gray-900 dark:text-white">
                          {model.price}
                        </span> import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
...
.Value -replace "'", "'" <span className="text-gray-600 dark:text-gray-400">starting</span>
                        )}
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                        {model.duration}

...
export default function InitialConsultationPage() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement> 'use client'
...
.Value -replace "'", "'" <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6"> 'use client'
...
.Value -replace "'", "'" </h2>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8 text-center">
          <div className="text-green-800">
            <h3 className="text-lg font-semibold mb-2">100% Satisfaction Guarantee</h3>
            <p className="text-sm"> 'use client'

/**
 * Guardian Plugin Marketplace API: Disable Government & Regulatory Pack
 *
 * Endpoint: POST /api/guardian/plugins/industry-government-regulatory-pack/disable
 */
...
const PLUGIN_KEY = 'industry_government_regulatory_pack';

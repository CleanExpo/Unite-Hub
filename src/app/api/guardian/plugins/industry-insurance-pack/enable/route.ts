/**
 * Guardian Plugin Marketplace API: Enable Industry Insurance Pack
 *
 * Endpoint: POST /api/guardian/plugins/industry-insurance-pack/enable
 *
 * Enables the Insurance & Claims Oversight plugin for a workspace.
...
const PLUGIN_KEY = 'industry_insurance_pack';

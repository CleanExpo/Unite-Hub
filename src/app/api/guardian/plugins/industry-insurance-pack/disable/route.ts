/**
 * Guardian Plugin Marketplace API: Disable Industry Insurance Pack
 *
 * Endpoint: POST /api/guardian/plugins/industry-insurance-pack/disable
 *
 * Disables the Insurance & Claims Oversight plugin for a workspace.
 */

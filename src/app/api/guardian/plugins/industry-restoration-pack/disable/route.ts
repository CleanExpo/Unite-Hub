/**
 * Guardian Plugin Marketplace API: Disable Industry Restoration Pack
 *
 * Endpoint: POST /api/guardian/plugins/industry-restoration-pack/disable
 *
 * Disables the Restoration Operations plugin for a workspace.
 */

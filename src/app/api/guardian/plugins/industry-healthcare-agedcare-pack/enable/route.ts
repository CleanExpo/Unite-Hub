/**
 * Guardian Plugin Marketplace API: Enable Industry Healthcare & Aged Care Pack
 *
 * Endpoint: POST /api/guardian/plugins/industry-healthcare-agedcare-pack/enable
 *
 * Enables the Healthcare & Aged Care Oversight plugin for a workspace.

/**
 * Google Search Console OAuth - Authorization URL Generator
 * GET /api/seo/gsc/auth-url
 *
 * Generates OAuth 2.0 authorization URL for Google Search Console.
 * Client redirects user to this URL to grant permissions.
 */

import { NextRequest, NextResponse } from "next/server";
import { getSupabaseServer } from "@/lib/supabase";
import { buildGscAuthUrl } from "@/lib/seo/integrations/gscClient";

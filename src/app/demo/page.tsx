  ...
  return (
    <div className="min-h-screen bg-bg-base flex items-center justify-center">
      <div className="text-center space-y-4">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-info-600 to-purple-600 rounded-2xl mb-4">
          <span className="text-text-primary font-bold text-2xl">🧪</span>
        </div>
        <h1 className="text-2xl font-bold text-text-primary">Entering Demo Mode</h1>
        <p className="text-text-muted">{status}</p>
        <div className="flex gap-2 justify-center items-center mt-4">
          <div className="w-2 h-2 bg-info-500 rounded-full animate-bounce" style={{ animationDelay: "0ms" }}></div>
          <div className="w-2 h-2 bg-info-500 rounded-full animate-bounce" style={{ animationDelay: "150ms" }}></div>
          <div className="w-2 h-2 bg-info-500 rounded-full animate-bounce" style={{ animationDelay: "300ms" }}></div>
        </div>
      </div>
    </div>
  );

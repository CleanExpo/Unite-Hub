      ...
      <section className="relative bg-[radial-gradient(circle_at_center_top,#0d2a5c_0%,#051224_70%)] text-white pt-40 pb-20 text-center overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-5 relative">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight">
            Marketing, SEO & AI.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#347bf7] to-[#00d4aa]">Without the Agency Bill.</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-5 mb-16">
            <Link
              href="/login"
              className="bg-gradient-to-r from-[#347bf7] to-[#5a9dff] text-white py-4 px-8 rounded-lg text-base font-semibold border-none shadow-[0_4px_15px_rgba(52,123,247,0.4)] hover:-translate-y-0.5 transition-transform"
            >
              Start My AI Marketing Trial
            </Link>
            <a
              href="#how-it-works"
              className="bg-white/10 backdrop-blur-sm text-white py-4 px-8 rounded-lg text-base font-semibold border border-white/30 hover:-translate-y-0.5 transition-transform"
            >
              See How It Works
            </a>
          </div>
          ...
          {/* Trust Elements */}
          <div className="max-w-[600px] mx-auto bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
      ...
      <section id="who-we-help" className="py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Trades & Contractors */}
            <div className="p-8 rounded-xl border border-[#e0e5ec] hover:border-[#347bf7] hover:shadow-lg transition-all">

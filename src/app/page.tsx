    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
              ...
              <span className="text-sm text-blue-300">AI-Powered Customer Relationship Management</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Link href="/login">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-2xl shadow-blue-500/50 text-lg px-8 py-6">
                  Start Free Trial
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="border-slate-600 hover:bg-slate-800 text-lg px-8 py-6">
                Watch Demo
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap justify-center items-center gap-8 pt-8 text-sm text-slate-400">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* Preview Cards */}
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-white/5">
                    <BarChart3 className="h-8 w-8 text-blue-400 mb-4" />
                    <h3 className="text-white font-semibold mb-2">Smart Analytics</h3>
                    <p className="text-slate-400 text-sm">AI-powered insights into your customer data</p>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-white/5">
                    <Mail className="h-8 w-8 text-purple-400 mb-4" />
                    <h3 className="text-white font-semibold mb-2">Email Automation</h3>
                    <p className="text-slate-400 text-sm">Personalized campaigns at scale</p>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-white/5">
                    <Users className="h-8 w-8 text-pink-400 mb-4" />
                    <h3 className="text-white font-semibold mb-2">Contact Management</h3>
                    <p className="text-slate-400 text-sm">Organize and segment with AI</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              <div
                key={index}
                className="group relative bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-white/5 hover:border-white/10 transition-all hover:shadow-2xl hover:shadow-blue-500/10"
              >
                <div className={`h-12 w-12 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
              ...
              <div key={index} className="relative">
                <div className="flex flex-col items-center text-center">
                  <div className="mb-6 relative">
                    ...
                    <div className="absolute -top-2 -right-2 h-8 w-8 rounded-full bg-slate-900 border-2 border-blue-500 flex items-center justify-center">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 p-12 text-center shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-400 text-sm">© 2025 Unite-Hub. All rights reserved.</span>
            </div>

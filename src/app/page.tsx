...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
              ...
              <span className="text-xs sm:text-sm text-blue-300">AI-Powered CRM</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center pt-2 sm:pt-4 px-4 sm:px-0">
              <Link href="/login" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-2xl shadow-blue-500/50 text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6">
                  Start Free Trial
                  <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="w-full sm:w-auto border-slate-600 hover:bg-slate-800 text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6">
                Watch Demo
            ...
            {/* Trust Indicators */}
            <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 pt-6 sm:pt-8 text-xs sm:text-sm text-slate-400 px-4 sm:px-0">
          ...
          <div className="mt-12 sm:mt-16 md:mt-20 relative px-2 sm:px-0">
            ...
            <div className="relative rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-4 sm:p-6 md:p-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                  {/* Preview Cards */}
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 sm:p-5 md:p-6 border border-white/5">
                    <BarChart3 className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-blue-400 mb-3 sm:mb-4" />
                    <h3 className="text-white font-semibold mb-1.5 sm:mb-2 text-sm sm:text-base">Smart Analytics</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">AI-powered insights into your customer data</p>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 sm:p-5 md:p-6 border border-white/5">
                    <Mail className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-purple-400 mb-3 sm:mb-4" />
                    <h3 className="text-white font-semibold mb-1.5 sm:mb-2 text-sm sm:text-base">Email Automation</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">Personalized campaigns at scale</p>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 sm:p-5 md:p-6 border border-white/5 sm:col-span-2 md:col-span-1">
                    <Users className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-pink-400 mb-3 sm:mb-4" />
                    <h3 className="text-white font-semibold mb-1.5 sm:mb-2 text-sm sm:text-base">Contact Management</h3>
                    <p className="text-slate-400 text-xs sm:text-sm">Organize and segment with AI</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            {[
              ...
              <div
                key={index}
                className="group relative bg-slate-800/50 backdrop-blur-sm rounded-xl p-5 sm:p-6 md:p-8 border border-white/5 hover:border-white/10 transition-all hover:shadow-2xl hover:shadow-blue-500/10"
              >
                <div className={`h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center mb-4 sm:mb-5 md:mb-6 group-hover:scale-110 transition-transform`}>
              ...
              <div key={index} className="relative">
                <div className="flex flex-col items-center text-center">
                  <div className="mb-5 sm:mb-6 relative">
                    <div className="h-16 w-16 sm:h-18 sm:w-18 md:h-20 md:w-20 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center">
                      <item.icon className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 text-white" />
                    </div>
                    <div className="absolute -top-2 -right-2 h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-slate-900 border-2 border-blue-500 flex items-center justify-center">
                  ...
                  <p className="text-slate-400 text-sm sm:text-base px-4 sm:px-0">{item.description}</p>
                </div>
                {index < 2 && (
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 p-6 sm:p-8 md:p-10 lg:p-12 text-center shadow-2xl">
            ...
            <div className="relative">
              ...
              <p className="text-base sm:text-lg md:text-xl text-blue-100 mb-6 sm:mb-7 md:mb-8 max-w-2xl mx-auto px-4 sm:px-0">
                Join thousands of businesses already using Unite-Hub to manage their customer relationships.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0">
                <Link href="/login" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto bg-white text-blue-600 hover:bg-blue-50 shadow-xl text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6">
                    Start Free Trial
                    <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                  </Button>
                </Link>
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 bg-slate-950/50 py-8 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-slate-400 text-xs sm:text-sm">
                <li><a href="https://unite-hub.com/about" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">About</a></li>
                <li><a href="https://unite-hub.com/blog" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">Blog</a></li>
                <li><a href="https://unite-hub.com/careers" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">Careers</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Support</h3>
              <ul className="space-y-1.5 sm:space-y-2 text-slate-400 text-xs sm:text-sm">
                <li><a href="https://help.unite-hub.com" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">Help Center</a></li>
                <li><a href="mailto:support@unite-hub.com" className="hover:text-white transition-colors">Contact</a></li>
                <li><a href="https://status.unite-hub.com" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">Status</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-white/10 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 sm:gap-6 order-1 sm:order-2">
              <a href="https://twitter.com/unitehub" className="text-slate-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                <span className="sr-only">Twitter</span>
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="https://github.com/CleanExpo/Unite-Hub" className="text-slate-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">

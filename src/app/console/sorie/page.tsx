...
export default function SORIEPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'ahead': return 'bg-green-900 text-green-400';
      case 'on_track': return 'bg-blue-900 text-blue-400';
      case 'at_risk': return 'bg-yellow-900 text-yellow-400';
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Strategic Objective & Roadmap Intelligence Engine</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-green-900/50 rounded-lg p-4">
          <div className="text-sm text-green-400">On Track</div>
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <div className="space-y-4">
          {objectives.map((obj) => (
            <div key={obj.id} className="border border-gray-700 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <Flag size={16} className={obj.priority === 'critical' ? 'text-red-400' : 'text-yellow-400'} />

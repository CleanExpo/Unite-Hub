...
export default function BillingPage() {
  ...
  const getStatusBadge = (status: string) => 'use client'
...
.Value -replace "'", "'" <Badge className="bg-green-600/20 text-green-400 border-green-800">Paid</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-yellow-600/20 text-yellow-400 border-yellow-800">Pending</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-red-600/20 text-red-400 border-red-800">Overdue</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-green-600/20 text-green-400 border-green-800">Active</Badge>
      default:
        return <Badge>{status}</Badge>
    }
  }

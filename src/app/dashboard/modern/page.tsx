    ...
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      <div className="flex items-center justify-between gap-6">
        <div className="flex-1 max-w-xl relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-bg-raised/50 border border-border-medium/50 rounded-lg text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-info-500 focus:border-transparent"
          />
        </div>

        <div className="flex items-center gap-4">
          <button className="relative p-2 rounded-lg bg-bg-raised/50 backdrop-blur-sm border border-border-medium/50 hover:bg-bg-hover/50 text-text-secondary transition-all">
            <Bell className="h-5 w-5" />
            <span className="absolute -top-1 -right-1 h-5 w-5 bg-gradient-to-r from-error-500 to-accent-500 rounded-full flex items-center justify-center text-xs text-text-primary font-semibold shadow-lg shadow-error-500/50">
              5
            </span>
          </button>

          <Avatar className="h-9 w-9">
            <AvatarFallback className="bg-gradient-to-br from-info-600 to-purple-600 text-text-primary">
              PH
            </AvatarFallback>
          </Avatar>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-text-primary">Active Projects</h2>
          <Button variant="outline" className="border-info-500/50 text-info-400 hover:bg-info-500/20">
            View All Projects
          </Button>
        </div>
        <ProjectCardGrid>

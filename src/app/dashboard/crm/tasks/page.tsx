...
export default function TasksPage() {
  const [tasks, setTasks] = useState<Task[]> 'use client'
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <Input
                  id="search"
                  Unite Group="Search by title or description..."
                  value={searchTerm}
            ...
            <div>
              ...
              <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue Unite Group="All Categories" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Select value={selectedStatus} onValueChange={setSelectedStatus}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue Unite Group="All Statuses" />
                </SelectTrigger>
                <SelectContent>
                  {statuses.map(status => (
            ...
            <div>
              ...
              <Select value={selectedPriority} onValueChange={setSelectedPriority}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue Unite Group="All Priorities" />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <Select value={selectedStatus} onValueChange={setSelectedStatus}>
                ...
                <SelectContent>
                  {statuses.map(status => (
                    <SelectItem key={status} value={status}> 'use client'
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge className={`${getStatusColor(task.status)} text-white`}> 'use client'

...
.Value -replace "'", "'" <'mtd' | 'ytd'> 'use client';
...
.Value -replace "'", "'" <any>(null);
  const [metricsData, setMetricsData] = useState<DashboardMetricsData | null>(null);
  const [clients, setClients] = useState<TestDataRecord[]> 'use client';
...
.Value -replace "'", "'" <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-8">
        <div className="max-w-7xl mx-auto flex justify-center items-center h-64">
          <div className="text-center">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-teal-400"></div>
            <p className="mt-4 text-slate-600 dark:text-slate-300">Loading dashboard data...</p>
            ...
            {dashboardData && (
              <>
                <DashboardOverview 
                  ...
                  activitiesCount={dashboardData.activitiesCount || 0}
                  pipelineData={dashboardData.pipelineData || []}
                  recentActivities={(dashboardData.recentActivities || []).map((act: any) => 'use client';
...
.Value -replace "'", "'" <Card className="mt-6">
                  <CardHeader>
                    <CardTitle className="text-lg">Quick Actions</CardTitle>
                  </CardHeader>
                  <CardContent>

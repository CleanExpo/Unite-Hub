...
export default function PermissionsPage() {
  ...
  const [selectedBusinessUnit, setSelectedBusinessUnit] = useState<string> 'use client';
    ...
    <div className="container mx-auto py-8">
      <div className="mb-6">
        ...
        <div className="flex gap-4 mb-6">
          <Input
            Unite Group="Search permissions..."
            value={searchTerm}
          ...
          <Select value={selectedBusinessUnit} onValueChange={setSelectedBusinessUnit}>
            <SelectTrigger className="w-[200px]">
              <SelectValue Unite Group="Select business unit" />
            </SelectTrigger>
            <SelectContent>
...
.Value -replace "'", "'" <string, Permission[]>);
...
.Value -replace "'", "'" <div className="container mx-auto py-8">
        <Card>
          <CardHeader>
            <CardTitle>Access Denied</CardTitle>
            <CardDescription>You do not have permission to view this page.</CardDescription>

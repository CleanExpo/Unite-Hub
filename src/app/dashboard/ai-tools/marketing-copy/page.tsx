    ...
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      <div className="flex items-center gap-4">
        <div className="p-3 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl shadow-lg">
          <Wand2 className="h-8 w-8 text-text-primary" />
        </div>
        <div>
          ...
          <p className="text-text-muted mt-1">Create compelling marketing copy with Claude AI</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-bg-raised/50 backdrop-blur-sm border-border-medium/50 p-6 space-y-4">
          <div>
            ...
            <Input
              ...
              className="bg-bg-base/50 border-border-medium/50 text-text-primary placeholder:text-text-muted"
            />
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              className="min-h-[100px] resize-none bg-bg-base/50 border-border-medium/50 text-text-primary placeholder:text-text-muted"
            />
          </div>

          <div>
            <label className="block text-sm font-medium text-text-secondary mb-2">Section Type</label>
            <select
              value={section}
              onChange={(e) => setSection(e.target.value)}
              className="w-full px-3 py-2 bg-bg-base/50 border border-border-medium/50 text-text-primary rounded-lg focus:ring-2 focus:ring-accent-500"
            >
        ...
        {/* Output Section */}
        <Card className="bg-bg-raised/50 backdrop-blur-sm border-border-medium/50 p-6 space-y-4">
          <h3 className="font-semibold text-xl text-text-primary">Generated Copy</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-text-secondary">Headline</label>
                  <Button
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-text-secondary">Subheadline</label>
                  <Button
                ...
                <p className="text-lg text-text-secondary">{generatedCopy.subheadline}</p>
              </div>

              {/* Body Copy */}
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-text-secondary">Body Copy</label>
                  <Button
                ...
                <p className="text-text-muted leading-relaxed">{generatedCopy.bodyCopy}</p>
              </div>
              ...
              <div className="text-xs text-text-muted pt-4 border-t border-border-medium/50">
      ...
      <Card className="bg-bg-raised/50 backdrop-blur-sm border-border-medium/50 p-6">
        <h3 className="font-semibold text-text-primary mb-3">Quick Examples:</h3>
        <div className="grid md:grid-cols-2 gap-3">
          {[
            ...
            <button
              ...
              className="p-3 text-left text-sm bg-bg-base/50 backdrop-blur-sm border border-border-medium/30 rounded-lg hover:border-border-subtle/50 transition-all"
            >
              <div className="font-medium text-text-primary">{example.name}</div>
              <div className="text-text-muted text-xs mt-1">{example.description}</div>
            </button>
          ))}
        </div>
      </Card>

...
export default function BundlesPage() {
  const formatCurrency = (amount: number) => import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
...
.Value -replace "'", "'" <Code className="h-8 w-8" /> import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
...
.Value -replace "'", "'" <Target className="h-8 w-8" />;
      default:
        return <Package className="h-8 w-8" />;
    }
  };
              ...
              <div key={bundle.id} className="relative">
                ...
                <Card className={`h-full ${index === 1 ? 'border-2 border-teal-600 shadow-xl' : ''} hover:shadow-xl transition-shadow`}>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="pt-4 border-t">
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        <strong>Ideal for:</strong> import { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';

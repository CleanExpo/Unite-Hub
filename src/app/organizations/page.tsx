...
export default function Organizations() {
  const [organizations, setOrganizations] = useState<Organization[]> "use client";
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  Unite Group="Enter organization name"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.industry} onValueChange={(value) => handleChange('industry', value)}>
                  <SelectTrigger>
                    <SelectValue Unite Group="Select industry" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.size} onValueChange={(value) => handleChange('size', value)}>
                  <SelectTrigger>
                    <SelectValue Unite Group="Select size" />
                  </SelectTrigger>
                  <SelectContent>
...
.Value -replace "'", "'" <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-teal-500 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-lg text-slate-300">Loading organizations...</p>
        </div>
...
.Value -replace "'", "'" </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="industry">Industry</Label>
                <Select value={formData.industry} onValueChange={(value) => "use client";
...
.Value -replace "'", "'" <SelectTrigger>
              ...
              <div className="space-y-2">
                <Label htmlFor="size">Company Size</Label>
                <Select value={formData.size} onValueChange={(value) => "use client";
...
.Value -replace "'", "'" <SelectTrigger>
        ...
        {organizations.length === 0 ? (
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-white">All Organizations</CardTitle>
              <CardDescription className="text-slate-400"> "use client";
                ...
                <TableBody>
                  {organizations.map((org) => (
                    <TableRow key={org.id} className="border-slate-700 hover:bg-slate-700">
                      ...
                      <TableCell className="text-slate-300"> "use client";

  ...
  return (
    <div className="min-h-screen bg-bg-base p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Filters skeleton */}
        <div className="bg-bg-raised/50 rounded-lg p-4 animate-pulse">
          <div className="flex items-center justify-between">
            <div className="h-10 bg-bg-elevated rounded w-64" />
            <div className="flex space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-8 bg-bg-elevated rounded w-20" />
              ))}
            </div>
          </div>
        </div>

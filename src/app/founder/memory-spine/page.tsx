...
return <div className="container mx-auto p-6"><div className="flex items-center justify-center h-64"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div></div>;
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card className="border-warning-200 bg-warning-50 dark:bg-warning-950/20"><CardContent className="py-4"><div className="flex gap-3"><AlertTriangle className="h-5 w-5 text-warning-600 flex-shrink-0" /><div className="text-sm text-warning-800 dark:text-warning-200"><div className="font-medium mb-1">Spine Integrity</div><p>Spine never alters linked records. Links discoverable and auditable. Traversal respects tenant and region boundaries.</p></div></div></CardContent></Card>
    </div>
  );
}

...
export default function CoachingPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card className="border-amber-200 bg-amber-50 dark:bg-amber-950/20"><CardContent className="py-4"><div className="flex gap-3"><AlertTriangle className="h-5 w-5 text-amber-600 flex-shrink-0" /><div className="text-sm text-amber-800 dark:text-amber-200"><div className="font-medium mb-1">Coaching Guidelines</div><p>Suggestions labeled as such. No guaranteed outcomes. References which dashboards triggered advice.</p></div></div></CardContent></Card>
    </div>
  );
}

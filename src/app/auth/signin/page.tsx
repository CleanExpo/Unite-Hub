      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-sm p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-mono font-bold text-white/90 mb-2">Sign in to continue</h1>
            <p className="text-white/40 font-mono text-sm">Access your marketing dashboard</p>
          </div>
          ...
          <button
            ...
            className="w-full h-12 bg-white/[0.04] hover:bg-white/[0.06] text-white/70 border border-white/[0.06] hover:border-white/[0.12] font-mono text-sm font-semibold rounded-sm transition-colors flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed mb-6"
          >
            {googleLoading ? (
              <>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#050505] px-3 text-white/30 font-mono tracking-widest">or</span>
            </div>
          </div>
          ...
          <div className="mt-6 text-center font-mono text-sm text-white/40">
            ...
            <Link href="/terms" className="text-[#00F5FF] hover:text-[#00F5FF]/80 transition-colors">Terms</Link>
            {" "}and{" "}
            <Link href="/privacy" className="text-[#00F5FF] hover:text-[#00F5FF]/80 transition-colors">Privacy Policy</Link>
          </div>
        </div>

        <p className="text-center text-sm font-mono text-white/30 mt-6">
          Need help?{" "}
          <a href="mailto:support@unite-group.in" className="text-[#00F5FF] hover:text-[#00F5FF]/80 transition-colors">
            Contact Support
          </a>
        </p>
      </div>

...
export default function AdminPage() {
  ...
  const [users, setUsers] = useState<AdminUser[]> 'use client'
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-green-400 mt-1">↗ 15% today</p>
                      </div>
                      <div className="h-12 w-12 rounded-lg bg-purple-600/20 flex items-center justify-center">
...
.Value -replace "'", "'" <Badge className="bg-green-600/20 text-green-400 border-green-800">Active</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-red-600/20 text-red-400 border-red-800">Suspended</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-yellow-600/20 text-yellow-400 border-yellow-800">Pending</Badge>
      default:
        return <Badge>{status}</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-purple-600/20 text-purple-400 border-purple-800">Admin</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-blue-600/20 text-blue-400 border-blue-800">Moderator</Badge> 'use client'
...
.Value -replace "'", "'" <Badge className="bg-slate-600/20 text-slate-400 border-slate-800">User</Badge>
      default:
        return <Badge>{role}</Badge> 'use client'
...
.Value -replace "'", "'" <Ban className="h-4 w-4" />
                              </Button>
                            ) : (
                              <Button 
                                variant="ghost" 
...
.Value -replace "'", "'" <CheckCircle className="h-4 w-4" />
                              </Button>
                            )}
                          </div>
                        </TableCell>

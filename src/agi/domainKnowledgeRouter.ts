...
export const domainProfiles: DomainProfile[] = [
  {
    ...
    preferredModels: ['claude-sonnet-4-6', 'gpt-4-turbo', 'gemini-3-pro'],
...

  {
    ...
    preferredModels: ['claude-sonnet-4-6', 'gpt-4-turbo'],
...

  {
    ...
    preferredModels: ['claude-opus-4-6', 'deepseek-r1', 'gpt-4-turbo'],
    requiresDisclaimer: true,

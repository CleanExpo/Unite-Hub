...
.Value -replace "'", "'" <GitBranch className="h-4 w-4" /> /**
 * Agent Dashboard Component
 * Main dashboard for monitoring and controlling the AI agent
 */
...
export default AgentDashboard;
.Value -replace "'", "'" <Terminal className="h-4 w-4" /> /**
 * Agent Dashboard Component
 * Main dashboard for monitoring and controlling the AI agent
 */
...
export default AgentDashboard;
.Value -replace "'", "'" <TestTube className="h-4 w-4" /> /**
 * Agent Dashboard Component
 * Main dashboard for monitoring and controlling the AI agent
 */
...
export default AgentDashboard;
.Value -replace "'", "'" <Zap className="h-4 w-4" />;
      default:
        return <Activity className="h-4 w-4" />;
    }
  };
...
export default AgentDashboard;
.Value -replace "'", "'" <div key={phase} className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        {getPhaseIcon(phase)}
                        <span className={`capitalize ${isCurrent ? 'font-semibold' : ''}`}>
                          {phase}

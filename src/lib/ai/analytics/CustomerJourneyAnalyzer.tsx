...
import ModernBlogPostTemplate, { Callout, CodeBlock, BlogChart } from '@/templates/ModernBlogPostTemplate';
import type { BlogPostMeta } from '@/templates/ModernBlogPostTemplate';
...
const SampleBlogContent: React.FC = () => {
  return (
    <>

...
const heroStatsTraining = [
  { value: "87%", label: "Skill Improvement", subLabel: "Average skill advancement", icon: TrendingUp },
  { value: "92%", label: "Knowledge Retention", subLabel: "After 6 months", icon: BookOpen },
  { value: "340%", label: "ROI on Training", subLabel: "Within first year", icon: DollarSignIcon },
  { value: "95%", label: "Employee Satisfaction", subLabel: "Training rating", icon: Users },
]
...
const trainingProgramCategories = [
  {
    ...
    programs: [
      { name: "Water Damage Restoration (WRT)", image: "/water-damage-restoration-certification.png" },
      { name: "Applied Structural Drying (ASD)", image: "/placeholder-66huc.png" },
      { name: "Fire & Smoke Restoration (FSRT)", image: "/placeholder-j59ba.png" },
  ...
  },
  {
    ...
    programs: [
      { name: "Modern Web Development", image: "/web-development-training.png" },
      { name: "Cloud Architecture (AWS/Azure)", image: "/cloud-architecture-course.png" },
      { name: "DevOps & CI/CD", image: "/devops-training-concept.png" },
      { name: "AI & Machine Learning", image: "/ai-ml-workshop.png" },
      { name: "Cybersecurity Fundamentals", image: "/placeholder.svg?width=300&height=200" },
      { name: "Database Design & Optimization", image: "/placeholder.svg?width=300&height=200" },
    ],
  },
  {
    id: "corporate",
    ...
    programs: [
      { name: "Leadership Development", image: "/placeholder.svg?width=300&height=200" },
      { name: "Change Management", image: "/placeholder.svg?width=300&height=200" },
      { name: "Digital Transformation", image: "/placeholder.svg?width=300&height=200" },
      { name: "Innovation Workshops", image: "/placeholder.svg?width=300&height=200" },
      { name: "Team Performance", image: "/placeholder.svg?width=300&height=200" },
      { name: "Strategic Planning", image: "/placeholder.svg?width=300&height=200" },
    ],
  },
  {
    id: "industry",
    ...
    programs: [
      { name: "Construction Safety", image: "/placeholder.svg?width=300&height=200" },
      { name: "Healthcare Compliance", image: "/placeholder.svg?width=300&height=200" },
      { name: "Financial Services", image: "/placeholder.svg?width=300&height=200" },
      { name: "Manufacturing Excellence", image: "/placeholder.svg?width=300&height=200" },
      { name: "Retail Management", image: "/placeholder.svg?width=300&height=200" },
      { name: "Hospitality Standards", image: "/placeholder.svg?width=300&height=200" },
    ],
  },
]
...
const trainingPackages = [
  ...
  },
  {
    ...
    priceLevels: [
      { level: "Free Library", price: "Free", details: "Access to basic resources" },
      { level: "Foundation", price: "A$44/mo", details: "Weekly sessions, basic mentoring" },
      { level: "Growth", price: "A$99/mo", details: "Personal mentoring, project assignments, certification prep" },
    ],
    description: "Comprehensive learning journey with ongoing support.",
    features: ["Access to CARSI resources", "Structured learning paths", "Progress tracking"], // Simplified for card
...
const whyTrainWithUs = [
  {
    ...
    description: "Learn from IICRC-approved and industry-certified experts with real-world experience.",
  },
  {
    icon: BookOpen,
    title: "Practical, Hands-on Learning",
    description: "Our programs emphasize practical application and skill development, not just theory.",
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: "We tailor training programs to meet the specific needs and goals of your organization.",
  },
]
    ...
    <div className="bg-slate-950 text-slate-200">
      ...
      >
        ...
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-xl text-slate-300 mb-10">
            Unite Group partners with CARSI to deliver world-class training and certifications. From IICRC restoration
            certifications to corporate leadership programs, we provide comprehensive education solutions that transform
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Button size="lg" asChild className="bg-amber-500 hover:bg-amber-600 text-white group">
              <Link href="https://carsi.com.au/" target="_blank" rel="noopener noreferrer">
            ...
            >
              <Link href="/contact?service=Custom%20Training%20Program">Design Custom Program</Link>
            </Button>
          </div>
        </div>
      </motion.section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white mb-4">Training Programs</h2>
            <p className="max-w-2xl mx-auto text-lg text-slate-300">
              Comprehensive programs designed for immediate impact and lasting transformation.
            </p>
          </div>
          <Tabs defaultValue={trainingProgramCategories[0].id} className="w-full">
            ...
            {trainingProgramCategories.map((category) => (
              <TabsContent key={category.id} value={category.id}>
                <p className="text-center text-slate-400 mb-8">{category.description}</p>
                  ...
                  {category.programs.map((program, idx) => (
                    ...
                    >
                      <Card className="bg-slate-800/50 border-slate-700/50 shadow-md h-full overflow-hidden group">
                        <Image
                          src={program.image || "/placeholder.svg?width=300&height=200&query=training+course"}
                          alt={program.name}
                          width={300}
                          height={200}
      ...
      <section className="py-16 md:py-24 bg-slate-900">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white mb-4">Why Train With Unite Group & CARSI?</h2>
            <p className="max-w-2xl mx-auto text-lg text-slate-300">
              Invest in training that delivers tangible skills and recognized credentials.
            </p>
          </div>
                ...
                <Card className="bg-slate-800/50 border-slate-700/50 shadow-lg h-full text-center hover:border-amber-500/60 transition-colors">
                  <CardHeader>
                    ...
                    <CardDescription className="text-slate-400 text-sm">
                      Duration: {option.duration} • Participants: {option.participants}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="max-w-2xl mx-auto text-lg text-slate-300">Investment in your team's future starts here.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 items-stretch">
            {trainingPackages.map((pkg, idx) => (
              ...
              >
                <Card
                  className={`w-full flex flex-col bg-slate-800/70 backdrop-blur-sm border-slate-700/50 shadow-xl relative overflow-hidden ${pkg.isPopular ? "border-2 border-amber-500 shadow-amber-500/30" : "border-slate-700"}`}
                >
                  {pkg.isPopular && (
                    ...
                    {pkg.priceLevels ? (
                      <div className="mb-2">
                        {pkg.priceLevels.map((level) => (
                          <div key={level.level} className="text-amber-300 mt-1">
                            <span className="font-semibold text-lg">{level.level}:</span>{" "}
                            <span className="text-2xl font-bold">{level.price}</span>
                            <p className="text-xs text-slate-400">{level.details}</p>
                          </div>
                        ))}
                      </div>
                    ) : (
                      <p className="text-3xl font-bold text-amber-300 mb-2">{pkg.price}</p>
                    )}
                  ...
                  <CardContent className="flex-grow flex flex-col">
                    <ul className="space-y-2.5 mb-6 flex-grow">
                      {pkg.features.map((feature, fIdx) => (
                        <li key={fIdx} className="flex items-start text-sm text-slate-300">
                          <CheckCircle size={18} className="text-amber-400 mr-2.5 mt-0.5 flex-shrink-0" />
                          {feature}
                        </li>
                      ))}
                    </ul>
                    ...
                    <Button
                      asChild
                      className={`w-full font-semibold text-lg py-3 mt-auto ${pkg.isPopular ? "bg-amber-500 hover:bg-amber-600 text-white" : "bg-slate-700 hover:bg-slate-600 text-slate-100"}`}
                    >
                      <Link href={`/contact?service=Education%20Training&package=${pkg.name}`}>
                        {pkg.price === "Coming Soon" ? "Learn More" : "Get Started"}
                      </Link>
                    </Button>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 md:py-32 bg-slate-900">
        <div className="container mx-auto max-w-screen-md px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-white mb-6">Invest in Your Team's Potential</h2>
          <p className="text-lg text-slate-300 mb-10">
            Empower your workforce with the skills and knowledge to drive innovation and achieve your business
            objectives. Let's design a training program that delivers results.
          </p>
          <Button size="xl" asChild className="bg-amber-500 hover:bg-amber-600 text-white group text-lg px-10 py-7">

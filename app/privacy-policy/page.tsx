...
export const metadata: Metadata = {
  ...
  description: "Understand how Unite Group collects, uses, and protects your personal information.",
}
    ...
    <div className="bg-slate-950 text-slate-200">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-slate-900 via-slate-950 to-black">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white mb-6">Privacy Policy</h1>
          <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto">
            Your privacy is critically important to us. This policy outlines how Unite Group handles your personal
            information.
          </p>
        ...
        <div className="container mx-auto max-w-screen-md px-4 sm:px-6 lg:px-8">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300 prose-headings:text-white prose-a:text-cyan-400 hover:prose-a:text-cyan-300 prose-strong:text-slate-100">
            <p className="border-l-4 border-cyan-500 pl-4 italic text-slate-400">
              <strong>Important Note:</strong> This is a template Privacy Policy and should be reviewed by a legal
            ...
            <p>
              Welcome to Unite Group (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). We are committed to
              protecting your personal information and your right to privacy. If you have any questions or concerns
              about this privacy notice, or our practices with regards to your personal information, please contact us
              at <a href="mailto:support@unite-group.in">support@unite-group.in</a>.
            </p>
            <p>This privacy notice describes how we might use your information if you:</p>
            <ul>
              <li>
                Visit our website at <Link href="/">https://unite-group.in</Link>
              </li>
            ...
            <ul>
              <li>
                <strong>&quot;Website&quot;</strong>, we are referring to any website of ours that references or links
                to this policy
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                mailing addresses; job titles; contact preferences; billing addresses; and other similar information.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                <strong>To post testimonials.</strong> We post testimonials on our Website that may contain personal
              ...
              <li>
                <strong>Administer prize draws and competitions.</strong> We may use your information to administer
            ...
            <p>
              Depending on your location, you may have certain rights under applicable data protection laws. These may
              ...
              below. We will consider and act upon any request in accordanceance with applicable data protection laws.
            </p>
            <p>
            ...
            <p>
              Our Service does not address anyone under the age of 13 (or 16 in some jurisdictions). We do not knowingly
              collect personally identifiable information from children under 13. If you are a parent or guardian and
            ...
            <p>
              ...
              &quot;Last updated&quot; date and the updated version will be effective as soon as it is accessible. If we
              make material changes to this privacy notice, we may notify you either by prominently posting a notice of
            ...
            <p>
              ...
              <a href="mailto:support@unite-group.in">support@unite-group.in</a> or by post to:
            </p>
            <p>
              Unite Group
              <br />

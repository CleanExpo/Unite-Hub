...
export const metadata: Metadata = {
  ...
  description: "Read the terms and conditions for using Unite Group's website and services.",
}
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-slate-900 via-slate-950 to-black">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto">
            Please read these terms carefully before using our services. This is a binding legal agreement.
          </p>
        ...
        <div className="container mx-auto max-w-screen-md px-4 sm:px-6 lg:px-8">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300 prose-headings:text-white prose-a:text-amber-400 hover:prose-a:text-amber-300 prose-strong:text-slate-100">
            <p className="border-l-4 border-amber-500 pl-4 italic text-slate-400">
              <strong>Important Note:</strong> This is a template Terms of Service and should be reviewed by a legal
              professional to ensure it complies with all applicable laws and regulations specific to your business
              operations and jurisdiction.
            </p>

            <h2>1. Agreement to Terms</h2>
            <p>
              By using our Services (as defined in our Privacy Policy), you agree to be bound by these Terms of Service
            ...
            <ul>
              <li>
                <strong>Eligibility:</strong> You must be at least 13 years old (or 16 in some jurisdictions) to use our
                Services. By agreeing to these Terms, you represent and warrant to us that you are of legal age to form
                a binding contract.
              </li>
              <li>
                <strong>User Accounts:</strong> You may need to create an account to access some of our Services. You
                are responsible for safeguarding your account and for all activities that occur under it.
              </li>
              <li>
                <strong>Acceptable Use:</strong> You agree not to misuse the Services or help anyone else to do so. This
                includes, but is not limited to, probing, scanning, or testing the vulnerability of any system or
                network.
              </li>
            </ul>
            ...
            <p>
              The Services and their original content (excluding Content provided by you or other users), features and
              functionality are and will remain the exclusive property of Unite Group and its licensors. Our trademarks
            ...
            <p>
              ...
              AT YOUR OWN RISK. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE SERVICE IS PROVIDED WITHOUT
              WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED.
            </p>
            <p>
              IN NO EVENT SHALL UNITE GROUP, NOR ITS DIRECTORS, EMPLOYEES, PARTNERS, AGENTS, SUPPLIERS, OR AFFILIATES,
            ...
            <p>
              You agree to defend, indemnify and hold harmless Unite Group and its licensee and licensors, and their
              ...
              any person using your account and password; b) a breach of these Terms, or c) Content posted on the
              Service.
            </p>

            <h2>9. Governing Law and Dispute Resolution</h2>
            <p>
              These Terms shall be governed and construed in accordance with the laws of Queensland, Australia, without
              regard to its conflict of law provisions. Any disputes will be resolved in the courts of Queensland.
            </p>
            ...
            <p>
              ...
              <a href="mailto:support@unite-group.in">support@unite-group.in</a>.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <Link href="/contact">
              <Button size="lg" className="bg-amber-500 hover:bg-amber-600 text-white font-semibold">
                Contact Us For Any Queries <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
          </div>
        </div>

...
ENV NEXTAUTH_URL="http://localhost:3008"
ENV NEXTAUTH_SECRET="placeholder-secret-key-32-chars-minimum"
ENV GOOGLE_CLIENT_ID="placeholder.apps.googleusercontent.com"
ENV GOOGLE_CLIENT_SECRET="GOCSPX-placeholder-secret-key-google-oauth-2025"

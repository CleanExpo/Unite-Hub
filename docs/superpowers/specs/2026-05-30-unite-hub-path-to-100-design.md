...
- **Acceptance:** prod ref recorded ✓; drift migrations confirmed applied-as-migrations ✓; route scan returns 0 VIOLATION routes (0.3) ✓; 46 service-role routes audited, 0 IDOR + both defence-in-depth gaps closed (0.4) ✓; verify loop green ✓. **Phase 0 closes when PR #67 merges.**

                      ...
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            {project.type} â€¢ Started {new Date(project.startDate).toLocaleDateString()}
                          </p>
                        </div>
                  ...
                  <div key={consultation.id} className="flex items-start gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 dark:text-gray-400">
                        {new Date(consultation.date).toLocaleDateString()} â€¢ {consultation.duration} min
                      </div>
                  ...
                  {customer.carsiEducation.coursesEnrolled.map((course) => (
                    <div key={course.courseId} className="space-y-2">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        {course.progress}% complete â€¢ Enrolled {new Date(course.enrollmentDate).toLocaleDateString()}
                      </p>
                    </div>
                  ))}
                </div>

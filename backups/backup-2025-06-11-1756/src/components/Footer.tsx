      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Unite Group</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services" className="text-gray-300 hover:text-white transition duration-200">
                  Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/initial-consultation" className="text-gray-300 hover:text-white transition duration-200">
                  Consultation
                </Link>
              </li>
              <li>
                <Link href="/services/software-development" className="text-gray-300 hover:text-white transition duration-200">
                  Software Development
                </Link>
              </li>
              <li>
                <Link href="/dashboard/crm" className="text-gray-300 hover:text-white transition duration-200">
                  CRM System
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            Â© {currentYear} Unite Group. All rights reserved.
          </p>

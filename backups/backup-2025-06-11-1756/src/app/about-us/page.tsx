...
export default function AboutUsPage() {
  ...
  const values = [
    ...
    },
    {
      ...
      description: "We don't just meet expectationsâ€”we exceed them with every delivery."
    }
  ];
              ...
              <div className="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl p-1">
                <div className="bg-slate-800 rounded-2xl p-8">
                  ...
                  <div className="space-y-2">
                    <p className="text-slate-400">ðŸ“ Brisbane, Australia</p>
                    <p className="text-slate-400">ðŸŒ Serving clients globally</p>
                    <p className="text-slate-400">ðŸ‘¥ 50+ expert professionals</p>
                  </div>
                </div>
              </div>
            </motion.div>

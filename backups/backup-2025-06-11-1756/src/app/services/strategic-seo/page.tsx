          ...
          <div className="relative container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                ...
                rankings â€“ we transform your organic presence into a revenue-generating machine.
              </p>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <div className="text-white">
                  <p className="font-semibold">$750 Value â€¢ No Obligations</p>
                </div>
              </div>
              <p className="mt-8 text-sm text-green-100">
                ðŸ“Š 20+ page detailed report â€¢ ðŸ” Technical analysis â€¢ ðŸ“ˆ Competitor insights
              </p>
            </div>
          </div>
        </section>

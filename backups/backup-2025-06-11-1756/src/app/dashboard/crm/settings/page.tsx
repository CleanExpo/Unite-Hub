          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="company-name" Unite Group="Enter your company name" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="timezone">Timezone</Label>
                <Select defaultValue="utc">
                  <SelectTrigger id="timezone">
                    <SelectValue Unite Group="Select timezone" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="usd">
                  <SelectTrigger id="currency">
                    <SelectValue Unite Group="Select currency" />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Receive email updates about your CRM activities</p>
                </div>
                <Switch />
              </div>
              <div className="flex items-center justify-between">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Show more information on screen</p>
                </div>
                <Switch />
              </div>
            </CardContent>

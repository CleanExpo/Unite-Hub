  ...
  return (
    <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <Card
              className={cn(
                ...
                plan.isPopular ? "border-2 border-cyan-500 shadow-cyan-500/30" : "border-slate-700",
              )}
            >
              {plan.isPopular && (
              ...
              <CardHeader className="pt-8">
                <CardTitle className="text-2xl font-semibold text-white mb-2">{plan.name}</CardTitle>
              ...
              <CardContent className="flex-grow">
                <div className="mb-6">
                  ...
                  {typeof plan.monthlyPrice === "number" && <span className="text-slate-400">/month</span>}
                  {billingCycle === "annually" && typeof plan.monthlyPrice === "number" && (
                ...
                <div className="mt-8">
                  <p className="text-sm font-medium text-slate-200 mb-3">What's included:</p>
                  <ul className="space-y-2.5">
                    {plan.features.map((feature, fIdx) => (
                      <li key={fIdx} className="flex items-start text-sm text-slate-300">
                        <CheckCircle size={18} className="text-cyan-400 mr-2.5 mt-0.5 flex-shrink-0" />
                        {feature}
                      </li>
                    ))}
                  </ul>
      ...
      <div className="text-center bg-slate-800/60 p-8 md:p-12 rounded-xl shadow-xl border border-slate-700/50">
        <h3 className="text-3xl md:text-4xl font-semibold text-white mb-4">Ready to transform your business?</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Button
            size="lg"
            asChild
            className="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold px-8 py-3.5 text-lg"
          >

...
import { Footer } from './_components/Footer'; // Import the new Footer component
      ...
      <main className="bg-gray-900 text-white">
        ...
        <section className="relative w-full aspect-[16/9] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 gap-y-6">
            ...
            <CtaButton href="/free-trial" showArrow>
              Start Free Trial
            <CtaButton href={pageContent.hero.cta.href} showArrow>
              {pageContent.hero.cta.text}
            </CtaButton>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold">
                {pageContent.features.headline}
              </h2>
              <p className="mt-4 text-lg text-gray-400 max-w-3xl mx-auto">
                {pageContent.features.description}
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {pageContent.features.items.map((feature) => {
                const Icon = featureIcons[feature.icon as keyof typeof featureIcons];
                return (
                  <div key={feature.title} className="bg-gray-800 p-8 rounded-lg border border-gray-700 flex flex-col items-start transition-transform hover:-translate-y-1">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-400">
                {pageContent.faq.description}
              </p>
            </div>
            <div className="space-y-4">
              {pageContent.faq.questions.map((faq) => (
                <details key={faq.question} className="group bg-gray-800 p-6 rounded-lg border border-gray-700">
        ...
        <section className="py-20 bg-gray-900">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <div className="mt-8">
              <CtaButton href={pageContent.finalCta.buttonHref} size="lg" showArrow>
